      ...
      <div className="md:w-2/5">
        ...
        <div className="flex items-center space-x-4 mb-6">
          <div className="flex items-center space-x-2">
            ...
            <span className={`${opensans_regular} pl-2 text-[#C11513FF] leading-[26px]`}>CONTACT US</span>
          </div>
        </div>
        ...
        <button onClick={()=> console.log("#")} className="bg-primary_bg text-white px-8  py-2 hover:text-[#FFFFFFFF] hover:bg-[#A01210FF] rounded-full">Book a demo</button>
      </div>
