  ...
  return (
    ...
    <div className="w-10/12 mx-auto">
      <div className="text-center mb-8">
        <button className={`border border-red-600 ${opensans_regular} text-[18px] leading-[28px] text-red-600 px-6 py-2 rounded-md`}>Browse all Services</button>
      </div>
      <div className="bg-[#FEF1F199]  h-[371px] rounded-md ">
        ...
        <div className="w-2/4 ">
          ...
          <div className="mt-4">
            <button className={`border ${opensans_regular} gap-x-3 text-[14px] leading-[22px] flex items-center justify-center border-red-600 text-red-600 px-6 py-2 rounded-md`}>Next
          <FaArrowLeftLong/>
            </button>
          </div>
        </div>
