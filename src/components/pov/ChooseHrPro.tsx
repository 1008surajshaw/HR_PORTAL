...
import { sarabun_bold ,opensans_bold,sarabun_regular} from "@/app/font";
const ChooseHrPro=()=>{
    return (
        ...
        <div className="max-w-7xl mx-auto pb-10">
          ...
          <div className="w-[438px] flex flex-col gap-6">
             <div>   
                                                        {/* // text-[#C11513FF] */}
              <h3 className={`${opensans_bold} leading-[26px]  text-red-600 mb-4`}>Comprehensive HR Solutions</h3>
            ...
            <div>
              <h3 className={`${opensans_bold} leading-[26px]  text-red-600 mb-4`}>AI-Driven Recruitment</h3>
              <p className={`${sarabun_regular} text-primary_text leading-[26px]`}>From recruitment to payroll, we offer a full suite of services to manage your HR functions seamlessly.</p>
            </div>
            <div>
              <h3  className={`${opensans_bold} leading-[26px]  text-red-600 mb-4`}>Cloud-Based Payroll</h3>
              <p className={`${sarabun_regular} text-primary_text leading-[26px]`}>Our secure, cloud-based payroll software ensures accuracy, compliance, and ease of use, enabling you to manage payroll from anywhere.</p>
            </div>
          </div>
          <div className="">
